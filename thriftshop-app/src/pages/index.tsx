  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-600">Sustainable Shopping</h3>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-600">Great Value</h3>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-600">Curated Selection</h3>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-600">Shop By Category</h2>
